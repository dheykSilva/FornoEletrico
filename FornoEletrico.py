...
''' Configuraçoes basicas do Raspberry PI 3 Model B'''
GPIO.setmode(GPIO.BOARD)
GPIO.setwarnings(False)

''' Valores constantes representando as portas dos leds, ligados ao Raspberry PI 3 Model B''' 
ledResistencia = 7
led40graus = 8
led30min = 33
led60min = 35
...
''' Valores constantes representando as portas dos botões, ligados ao Raspberry PI 3 Model B'''
botaoPower = 16
botaoTemperatura = 18
botaoDesabilita = 32
...
''' Valores constantes iniciais para contadores (controle de interaçoes e afins)'''
contador = 0
contadorInteracao = 0
contadortempo = 0

''' Valores iniciais para flags de controle'''
botaoControle = False
...
''' Valores constantes para controle de tempo'''
tempo1 = 40
tempo2 = 60
tempo3 = 80
tempo4 = 100
...
''' Loop infinito que inicia o software'''
while(1):
    
    ''' Condição para verificar se o botão de POWER foi pressionado, caso sim, suas consequencias'''
    ...
    ''' Condição para verificar se a flag botaoControle é verdadeira, caso sim, suas consequencias'''
    if botaoControle == True:
        if contador != 0:
                GPIO.output(ledDesabilitado, False)
                
        ''' Condição para verificar se o botão de DESABILITA foi pressionado, caso sim, suas consequencias'''
        ...
        ''' Condição para verificar se o botão de SELEÇÂO DE TEMPERATURA foi pressionado, caso sim, suas consequencias'''        
        ...
        ''' Condição para verificar se o botão de SELEÇÂO DE TEMPO foi pressionado, caso sim, suas consequencias'''
        ...
        ''' Condição para verificar se o botão de SELEÇÂO CONFIRMA foi pressionado, caso sim, suas consequencias'''
        if GPIO.input(botaoConfirmar) == True:
            time.sleep(0.5)
            
            ''' Condição para verificar qual temperatura e qual o tempo, e suas consequencias'''
            if contadortempo == 1:
                if contador == 1:
                    t = time.time()
                    while (time.time() - t < tempo1):
                        ...
                        ''' Condição para verificar se o botão do EXAUSTOR foi pressionado, caso sim, suas consequencias'''
